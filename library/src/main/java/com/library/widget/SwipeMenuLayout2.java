...
public class SwipeMenuLayout2 extends FrameLayout {
    ...
    public SwipeMenuLayout2(View contentView, View menuView, Interpolator closeInterpolator,
    ...
    public SwipeMenuLayout2(View contentView, View menuView) {
        this(contentView, menuView, null, null);
    }

    private SwipeMenuLayout2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    private SwipeMenuLayout2(Context context) {
        super(context);
    }
